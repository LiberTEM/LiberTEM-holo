...
def get_git_rev():
    # NOTE: this is a copy from src/libertem_holo/versioning.py
...
def write_baked_revision(base_dir):
    dest_dir = os.path.join(base_dir, 'libertem_holo')
...
setup(
    name="libertem-holo",
    version=find_version("src", "libertem_holo", "__version__.py"),
    license='GPL v3',
    ...
    description="Insert PyPi description here",
    long_description=remove_rst_roles(read("README.rst")),
    long_description_content_type="text/x-rst",
    url="https://libertem.github.io/LiberTEM-holo",

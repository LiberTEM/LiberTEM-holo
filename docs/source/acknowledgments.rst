...
The following people in alphabetical order contributed to the LiberTEM-holo project
in other ways.
...
LiberTEM-holo kindly acknowledges funding and support from the following sources:

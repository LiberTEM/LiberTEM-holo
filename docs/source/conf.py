...
import libertem_holo  # NOQA: E402

# -- Project information -----------------------------------------------------

project = 'LiberTEM-holo'
copyright = 'LiberTEM-holo Authors'
author = 'the LiberTEM team'

_version_bits = libertem_holo.__version__.split('.')
# The short X.Y version
version = _version_bits[0] + '.' + _version_bits[1]
# The full version, including alpha/beta/rc tags

release = libertem_holo.__version__
...
htmlhelp_basename = 'libertem_holodoc'
...
latex_documents = [
    (master_doc, 'LiberTEM-holo.tex', 'LiberTEM-holo Documentation',
...
man_pages = [
    (master_doc, 'libertem_holo', 'LiberTEM-holo Documentation',
     [author], 1)
]
...
# GitHub repo
issues_github_path = "LiberTEM/LiberTEM-holo"
